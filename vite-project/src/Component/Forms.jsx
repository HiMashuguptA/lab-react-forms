...
const Form = () => {
  ...
  const validate = (data) => {
    ...
    if (data.firstName.trim() == "") {
      error.formData = "Please enter your First Name";
    }
    if (data.lastName.trim() == "") {
      error.formData = "Please enter your Last Name";
    }
    if (data.email.trim() == "") {
      error.formData = "Please enter your Email";
    }
    if (data.phoneNo.trim() == "") {
      error.formData = "Please Enter your phone number";
    }
    if (data.phoneNo.trim().length !== 10) {
      console.log(data.phoneNo.trim().length);
      error.formData = "Please enter 10-digit Phone number";
    }
    return error;
  };
  return (
